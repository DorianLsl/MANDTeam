 ...
 * 
 * import model.Example; import model.IModel; import view.IView;
 * 
 ...
 * 
 * public ControllerFacade(final IView view, final IModel model) { super();
 * this.view = view; this.model = model; }
 * 
 * public void start() throws SQLException {
 * this.getView().displayMessage(this.getModel().getExampleById(1).toString());
 * 
 * this.getView().displayMessage(this.getModel().getExampleByName("Example 2").
 * toString());
 * 
 ...
 * 
 * public IView getView() { return this.view; }
 * 
